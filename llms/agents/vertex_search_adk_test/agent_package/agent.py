...
def get_secret(project_id: str, secret_id: str, version_id: str = "latest") -> str:
    ...
    name = f"projects/sv-ml-sandbox/secrets/sv_secret_1/versions/1"
...
root_agent = LlmAgent(
    ...
    You always - and I mean *ALWAYS* - must provide a link to the document from which you are pulling your answer from.
